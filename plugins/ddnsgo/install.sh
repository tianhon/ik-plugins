...
install()
{
	...
	ln -fs $INSTALL_DIR/bin/ddnstod /usr/sbin/ddnstod
	ln -fs $INSTALL_DIR/bin/ddwebdav /usr/sbin/ddwebdav
	chmod  +x $INSTALL_DIR/bin/ddnstod $INSTALL_DIR/bin/ddwebdav
...
__uninstall()
{
	...
	rm /usr/sbin/ddnstod /usr/sbin/ddwebdav
}
